...
dmtcp_launch /home/mark/linux-3.11.0/tools/lguest/lguest 256 /home/mark/linux-3.11.0/vmlinux --verbose --tunnet=192.168.19.1 --initrd=/boot/initrd.img-3.11.10.5-lguest --snapshot=hello root=/dev/vda1 init=/sbin/init
