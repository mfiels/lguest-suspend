...
/home/mark/linux-3.11.0/tools/lguest/lguest 256 /boot/vmlinuz-3.11.10.5-lguest --verbose --tunnet=192.168.19.1 --block=/home/mark/hda.vdi --initrd=/boot/initrd.img-3.11.10.5-lguest --snapshot=hello --clean root=/dev/vda1 init=/sbin/init
